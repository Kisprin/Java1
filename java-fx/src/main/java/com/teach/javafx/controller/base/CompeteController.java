...
public class CompeteController extends ToolController {
    @FXML
    ...
    private Integer competeId = null;
    ...
    public void initialize() {
        ...
        req.add("numName","");
        res = HttpRequestUtil.request("/api/compete/getCompeteList",req); //从后台获取所有学生信息列表集合
    ...
    protected void changeStudentInfo() {
        ...
        DataResponse res = HttpRequestUtil.request("/api/compete/getCompeteInfo", req);
        if (res.getCode() != 0) {
    ...
    protected void onSaveButtonClick () {
        ...
        req.add("studentId", studentId);
        req.add("form", form);
        DataResponse res = HttpRequestUtil.request("/api/compete/competeEditSave", req);
        if (res.getCode() == 0) {
    ...
    protected void onQueryButtonClick () {
        ...
        DataResponse res = HttpRequestUtil.request("/api/compete/getCompeteList", req);
        if (res != null && res.getCode() == 0) {
            studentList = (ArrayList<Map>) res.getData();
            setTableViewData();
        }
    ...
    protected void onDeleteButtonClick () {
        ...
        competeId = CommonMethod.getInteger(form, "competeId");
        DataRequest req = new DataRequest();
        req.add("competeId", competeId);
        DataResponse res = HttpRequestUtil.request("/api/compete/competeDelete", req);
        if (res.getCode() == 0) {
