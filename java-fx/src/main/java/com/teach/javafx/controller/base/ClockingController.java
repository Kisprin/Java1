...
public class ClockingController extends ToolController {
    @FXML
    ...
    private Integer clockingId = null;
    ...
    public void initialize() {
        ...
        req.add("numName","");
        res = HttpRequestUtil.request("/api/clocking/getClockingList",req); //从后台获取所有学生信息列表集合
    ...
    protected void changeStudentInfo() {
        ...
        DataResponse res = HttpRequestUtil.request("/api/clocking/getClockingInfo", req);
        if (res.getCode() != 0) {
    ...
    protected void onSaveButtonClick () {
        ...
        req.add("studentId", studentId);
        req.add("form", form);
        DataResponse res = HttpRequestUtil.request("/api/clocking/clockingEditSave", req);
        if (res.getCode() == 0) {
    ...
    protected void onQueryButtonClick () {
        ...
        DataResponse res = HttpRequestUtil.request("/api/clocking/getClockingList", req);
        if (res != null && res.getCode() == 0) {
            studentList = (ArrayList<Map>) res.getData();
            setTableViewData();
        }
    ...
    protected void onDeleteButtonClick () {
        ...
        clockingId = CommonMethod.getInteger(form, "clockingId");
        DataRequest req = new DataRequest();
        req.add("clockingId", clockingId);
        DataResponse res = HttpRequestUtil.request("/api/clocking/clockingDelete", req);
        if (res.getCode() == 0) {
